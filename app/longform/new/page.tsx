  ...
  return (
    <main className="px-4 py-8 md:max-w-2xl md:mx-auto">
      ...
      <p className="mt-2 text-xs text-zinc-500">
        완성된 숏폼 2~30편을 골라 가로 16:9 롱폼으로 묶어요. <b>고른 순서</b>가 이어붙이는 순서입니다(대본
        단계에서 순서 재설계 제안을 받을 수 있어요). 각 숏폼은 16:9로 재생성(대본·음성 재활용)되고,
        세그먼트 사이엔 진행자가 나와 이어줍니다. 아래 검색은 <b>제목·나레이션</b>을 옛날 것까지 뒤지고,
        검색해도 고른 순서는 유지됩니다.
      </p>
