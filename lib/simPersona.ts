...
export async function generateSimPersona(args: {
  ...
  const system = [
    ...
    "3) 좋아하는 반응 — 호감이 오르는 플레이어의 반응 유형 3~4개 (예: 능청스럽게 받아치기)",
    "4) 싫어하는 반응 — 호감이 깎이는 반응 유형 3~4개 (예: 정면 돌직구, 성의 없는 단답)",
    "5) 지뢰(민감 주제) — 좋은 뜻으로 말해도 기분이 확 상하는 주제 2~3개. 이 인물의 콤플렉스·상처·자존심과 엮어라(예: 재벌남에게 '돈 많잖아'식 칭찬, 외모 강조, 과거 언급).",
    "6) 느끼함 내성 — 과한 칭찬·들이대는 멘트에 얼마나 부담을 느끼는지, 어떤 식으로 반응하는지.",
    "7) 첫 태도 — 아직 서먹한 사이(호감 20/100)에서 플레이어를 대하는 거리감",
